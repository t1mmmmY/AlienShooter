...
public class BulletMult : MonoBehaviour 
{
	...
	public NetworkController owner { get; private set; }
	...
	public void Init(Vector2 speed, Material material, NetworkController owner)
	{
		this.owner = owner;
...
//		BulletsManager.RemoveBullet(this);
	...
	void OnTriggerEnter2D(Collider2D other) 
	{
		...
		BulletMult otherBullet = other.GetComponent<BulletMult>();
		if (otherBullet != null)
		{
